    ...
    <section className="relative h-[40vh] min-h-[300px] overflow-hidden">
      ...
      <div className="relative container mx-auto px-4 h-full flex flex-col items-center justify-center text-center">
        <h1 className="text-5xl md:text-7xl font-bold mb-4 animate-fade-in">
          <span className="bg-gradient-to-r from-white via-primary to-white bg-clip-text text-transparent">Top Up Your Games</span>
        </h1>
        ...
        <div className="mt-8 animate-fade-in" style={{ animationDelay: "0.4s" }}>
          <button className="px-8 py-3 bg-accent text-accent-foreground rounded-lg font-semibold hover:scale-105 transition-transform shadow-glow-accent">Get Started Now</button>
        </div>
      </div>
    </section>
  );
