  ...
  return (
    <main
      ...
      className={cn(
        ...
        "group-data-[variant=inset]/sidebar-wrapper:m-2 group-data-[variant=inset]/sidebar-wrapper:rounded-xl group-data-[variant=inset]/sidebar-wrapper:border group-data-[variant=inset]/sidebar-wrapper:border-sidebar-border",
        className,
      )}
      {...props}
    />
...
const SidebarInput = React.forwardRef(function SidebarInput({ className, ...props }, ref) {
  return (
    <div
      data-sidebar="input"
      className={cn("flex h-8 items-center gap-2 rounded-md border px-2 text-sm", className)}
      {...props}
    >
      <Input
        ref={ref}
        className="h-6 border-none bg-transparent p-0 text-xs shadow-none outline-none ring-0 focus-visible:ring-0"
      />
    </div>
  );
});
...
const SidebarFooter = React.forwardRef(function SidebarFooter({ className, ...props }, ref) {
  return (
    <div
      ref={ref}
      data-sidebar="footer"
      className={cn("flex flex-col gap-2 border-t px-2 py-3", className)}
      {...props}
    />
  );
});
...
const SidebarContent = React.forwardRef(function SidebarContent({ className, ...props }, ref) {
  return (
    <div
      ...
      className={cn("flex min-h-0 flex-1 flex-col gap-2 overflow-hidden px-2 py-3", className)}
      {...props}
    />
  );
});
...
const SidebarGroupLabel = React.forwardRef(function SidebarGroupLabel({ className, ...props }, ref) {
  return (
    <div
      ...
      className={cn(
        "flex h-8 items-center justify-between text-xs font-medium text-sidebar-foreground/70",
        "group-data-[collapsible=icon]:h-8 group-data-[collapsible=icon]:justify-center group-data-[collapsible=icon]:text-xs group-data-[collapsible=icon]:text-sidebar-foreground",
        className,
      )}
      {...props}
    />
